...
console.log('[rep+] main.js loaded - initializing extension...');

document.addEventListener('DOMContentLoaded', () => {
    console.log('[rep+] DOMContentLoaded - starting initialization...');
    
    // Initialize UI Elements
    initUI();
    console.log('[rep+] UI initialized');
    ...
    initSearch();
    console.log('[rep+] Features initialized');
    ...
    console.log('[rep+] ✅ All initialization complete!');
});
