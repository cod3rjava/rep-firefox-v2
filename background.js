...
function setupListeners() {
    if (browserAPI.webRequest) {
        if (!browserAPI.webRequest.onBeforeRequest.hasListener(handleBeforeRequest)) {
        ...
        if (!browserAPI.webRequest.onBeforeSendHeaders.hasListener(handleBeforeSendHeaders)) {
        ...
        if (!browserAPI.webRequest.onCompleted.hasListener(handleCompleted)) {
        ...
        if (!browserAPI.webRequest.onErrorOccurred.hasListener(handleErrorOccurred)) {
